...
import { Builder, BuilderFieldsLogic } from "./builder-schema";
import { useBuilderQuery, useBuilderMutation } from "./use-builder-query";
import { useBuilderFieldsForm } from "./use-builder-fields-form";

export const BuilderFieldsForm = () => {
  const { fields } = useBuilderQuery([]);
  const { mutate } = useBuilderMutation();
  const { form } = useBuilderFieldsForm();
                          ...
                          <div className="flex gap-4">
                            <div className="">
                              <form.AppField
                                ...
                                children={(field) => (
                                  <field.TextField label="Min Length" />
                                )}
                              />
                            </div>
                            <div className="">
                              <form.AppField
                                ...
                                children={(field) => (
                                  <field.TextField label="Max Length" />
                                )}
                              />
                            </div>
                          </div>
