...
const organization = require('../shared/better-auth.DPjhN9w6.cjs');
...
const admin = require('../shared/better-auth.rzigBjjF.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.Bu6UgQrE.cjs');
const plugins_captcha_index = require('./captcha/index.cjs');
const plugins_oneTimeToken_index = require('../shared/better-auth.Cm8OvsAW.cjs');
...
require('../shared/better-auth.CVwggEK6.cjs');
